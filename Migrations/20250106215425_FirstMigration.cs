...
namespace EventManager.Migrations
{
    ...
    public partial class FirstMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "EventHasAtendee",
                columns: table => new
                {
                    AtendeesId = table.Column<int>(type: "int", nullable: false),
                    EventsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventHasAtendee", x => new { x.AtendeesId, x.EventsId });
                    table.ForeignKey(
                        name: "FK_EventHasAtendee_Atendees_AtendeesId",
                        column: x => x.AtendeesId,
                        principalTable: "Atendees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EventHasAtendee_Events_EventsId",
                        column: x => x.EventsId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventHasAtendee_EventsId",
